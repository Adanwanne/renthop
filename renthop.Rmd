...
# To prep the data for tfidf, make everything lowercase, remove all non-word characters, remove break tags, remove text between '<' and '/>'. Replace any removals with blank space.

#' Is data after the <br/> character important? In particular, after the last one there's information about property manager.
```
